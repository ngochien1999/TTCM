...
namespace QL
{
    public partial class frmthemthongtincb : Form
    {
        public frmthemthongtincb()
        {
            InitializeComponent();
        }
        ...
        private void Form11_Load(object sender, EventArgs e)
        {
            ...
            txtma.DisplayMember = "TenMB";
            txtma.ValueMember = "MaMB";
            txtma.DataSource = quanlichuan.Maybays.ToList();


            txttuyen.DisplayMember = "MaTB";
            txttuyen.ValueMember = "MaTB";
            txttuyen.DataSource = quanlichuan.Tuyenbays.ToList();
        }
        ...
        private void gunaButton6_Click(object sender, EventArgs e)
        {
            ...
            quanlichuan.chuyenbay_ha(txtma.SelectedValue.ToString(), txtmac.Text, Convert.ToDateTime(dtngay.Text), TimeSpan.Parse(tbgiobay.Text), cbden.SelectedValue.ToString(), cbdi.SelectedValue.ToString(), int.Parse(txtI.Text), int.Parse(txtII.Text), txttuyen.SelectedValue.ToString(), TimeSpan.Parse(dtThoiGiandung.Text), cbTrungGian.SelectedValue.ToString());
            ...
            //MessageBox.Show("Đã thêm thành công !!!");
            frmchuyenbay f = new frmchuyenbay();
            f.Show();
            this.Close();
        }
    }
